...
const classPacks: { classes: number; price: string; oldPrice?: string; validity: string; description: string; link: string }[] = [
  ...
  { classes: 6, price: "€115", oldPrice: "€130", validity: "60-day expiry", description: "Get access to 6 classes, valid for 60 days.", link: "https://momence.com/m/856816" },
  { classes: 10, price: "€190", oldPrice: "€215", validity: "310-day expiry", description: "Get access to 10 classes, valid over 10 months.", link: "https://momence.com/m/856813" },
  { classes: 20, price: "€370", oldPrice: "€400", validity: "610-day expiry", description: "Get access to 20 classes, valid over 20 months.", link: "https://momence.com/m/856815" },
];
