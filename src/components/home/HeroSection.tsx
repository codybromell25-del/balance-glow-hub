...
const HeroSection = () => {
  return (
    <section
      className="min-h-[65vh] flex items-end bg-cover bg-center relative"
      style={{ backgroundImage: `url(${heroImage})` }}
    >
      {/* Dark overlay for text readability */}
      <div className="absolute inset-0 bg-black/40" />

      <div className="container mx-auto px-4 py-20 pb-24 relative z-10">
        <div className="max-w-4xl mx-auto text-center animate-fade-in">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-heading font-black text-white mb-12 leading-tight tracking-tight">
            ...
            Reformer Pilates.
            <br />
            <span className="block font-light italic">Redefined.</span>
          </h1>
