      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12 md:mb-16 animate-fade-in">
          <div className="flex items-center justify-center gap-4 mb-4">
            ...
            <span className="text-foreground/60 text-sm uppercase tracking-[0.2em]">Our Routines</span>
            <span className="w-8 h-[1px] bg-foreground/30"></span>
          </div>
          <h2 className="text-3xl md:text-5xl font-heading italic text-foreground tracking-tight">
            Explore our three distinct classes
          </h2>
        </div>
