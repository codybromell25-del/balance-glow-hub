      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-2xl mx-auto">
          <div className="relative bg-background p-10 rounded-2xl border-2 border-primary/40 hover:border-primary/60 hover:shadow-lg transition-all duration-300">
            ...
            <Button className="w-full text-lg py-6 font-heading font-medium relative bg-gradient-to-r from-[#d8a4a8] via-[#e8b4b8] to-[#d8a4a8] text-white border-0 shadow-lg hover:brightness-105 overflow-hidden">
