        ...
        <div className="max-w-2xl mx-auto">
          <div className="relative bg-background p-10 rounded-2xl border-2 border-primary/40 hover:border-primary/60 hover:shadow-lg transition-all duration-300">
            <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
              <div className="bg-gradient-to-r from-[#9d8473] via-[#ad9383] to-[#9d8473] text-foreground px-6 py-2 rounded-full font-semibold flex items-center gap-2 shadow-lg">
            ...
            <Button className="w-full text-lg py-6 font-heading font-medium bg-gradient-to-r from-[#9d8473] via-[#ad9383] to-[#9d8473] text-foreground border-0 shadow-lg hover:brightness-105">Purchase Intro Offer</Button>
          </div>
        </div>
