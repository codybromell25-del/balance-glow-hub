...
const StudioKildare = () => {
  const studioInfo = {
    ...
    heroDescription: "Whether you're a beginner or an experienced practitioner, balance. Kildare Town has the perfect class for you. Secure your spot with our limited Intro Offer: 3 classes for just €45, or explore our flexible class packs and memberships to suit your schedule.",
    detailDescription: "Elevate your fitness routine at the ultimate Reformer Pilates studio in Kildare Town. Located in the heart of Claregate Street, our purpose-built studio features state-of-the-art reformers offering the ultimate boutique experience. With easy access from surrounding areas, we're ready to welcome you.",
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start max-w-6xl mx-auto">
              ...
              <div className="animate-fade-in" style={{ animationDelay: "0.1s" }}>
                <img src={studioKildare} alt="balance. Kildare Town Studio" className="w-full h-[400px] object-cover rounded-2xl shadow-xl" />
              </div>
            </div>
          </div>
        </section>
