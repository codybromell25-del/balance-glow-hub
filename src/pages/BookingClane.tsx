...
const BookingClane = () => {
  ...
  return (
    <div className="min-h-screen">
      <SEO 
        title="Book Clane Studio | balance studios - Reformer Pilates"
        description="Book your Reformer Pilates class at balance Clane. Located in Yew Tree Square, Clane, Co. Kildare. Morning, afternoon and evening classes available."
        canonical="/booking/clane"
      />
      <Navigation />
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="bg-card rounded-xl border border-border overflow-hidden shadow-lg" style={{ height: 'calc(100vh - 200px)', minHeight: '600px' }}>
                <iframe 
                  src="https://momence.com/m/62930?location_id=117422"
                  className="w-full h-full border-0"
                  title="Book Clane Studio"
                  loading="lazy"
                />
              </div>
            </div>
