...
const BookingClane = () => {
  ...
  return (
    <div className="min-h-screen">
      <SEO title="Book Clane | balance studios" description="Book your Reformer Pilates class at balance Clane. View available times and reserve your spot." canonical="/booking/clane" />
      <Navigation />
