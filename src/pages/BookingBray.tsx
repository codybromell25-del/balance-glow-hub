...
const BookingBray = () => {
  ...
  return (
    <div className="min-h-screen">
      <SEO title="Book Bray | balance studios" description="Book your Reformer Pilates class at balance Bray. View available times and reserve your spot." canonical="/booking/bray" />
      <Navigation />
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              ...
              <p className="text-lg text-foreground text-center mb-8">
                Reserve your spot at our Bray location
              </p>
              ...
              <div className="bg-card rounded-xl border border-border overflow-hidden shadow-lg" style={{ height: 'calc(100vh - 200px)', minHeight: '600px' }}>
                <iframe 
                  src="https://momence.com/m/62930?location_id=117426"
                  className="w-full h-full border-0"
                  title="Book Bray Studio"
                  loading="lazy"
                />
              </div>
            </div>
