...
import { MapPin, Mail, Phone, Instagram, Users, Clock, Check, Sparkles, ChevronDown } from "lucide-react";
...
const StudioClane = () => {
  const studioInfo = {
    ...
    heroDescription: "Whether you're a beginner or an experienced practitioner, balance. Clane has the perfect class for you. Secure your spot with our limited Intro Offer: 3 classes for just €45, or explore our flexible class packs and memberships to suit your schedule.",
    detailDescription: "Elevate your fitness routine at the ultimate Reformer Pilates studio in Clane. Discover our purpose-built studio in the heart of Clane, featuring state-of-the-art reformers, offering the ultimate boutique experience. Just a short drive from surrounding areas, our studio sits proudly in Yew Tree Square, ready to welcome you.",
  ...
  const beforeClassItems = [
    {
      title: "Shoe-Free Studio",
      content: "We're a shoe-free studio to keep our space clean and peaceful. Please remove your shoes at the entrance.",
    },
    {
      title: "Grip Socks",
      content: "Grip socks are required for all classes. You can purchase a pair at the studio if needed.",
    },
    {
      title: "Clean your Reformer",
      content: "Please wipe down your reformer with the provided cleaning supplies after each class.",
    },
    {
      title: "Arrive Early for Your First Class",
      content: "We invite you to arrive 15 minutes before your first class. This allows us to give you a tour and ensure you're comfortable with the reformer.",
    },
    {
      title: "Mom to Be",
      content: "Pregnant clients are welcome! Please inform your instructor before class so they can offer modifications.",
    },
  ];
              ...
              <div className="space-y-6 animate-fade-in" style={{ animationDelay: "0.1s" }}>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground">{studioInfo.address}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${studioInfo.email}`} className="text-foreground hover:text-primary transition-colors">{studioInfo.email}</a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href={`tel:${studioInfo.phone}`} className="text-foreground hover:text-primary transition-colors">{studioInfo.phone}</a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground">{studioInfo.instagram}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-xs text-muted-foreground uppercase tracking-wider mb-1">Capacity per class</p>
                    <p className="text-foreground">{studioInfo.capacity}</p>
                  </div>
                </div>
        ...
        <section className="py-12 md:py-20">
          <div className="container mx-auto px-4">
            <div className="text-center mb-10">
              ...
              <h2 className="text-3xl md:text-4xl font-heading italic text-foreground">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
              ...
              <div className="animate-fade-in">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Whether you're an experienced practitioner or new to Reformer Pilates, we invite you to arrive 15 minutes before your class starts. This allows us to give you a tour and ensure you're comfortable with the reformer. Here are a few things to keep in mind:
                </p>
              </div>
                ...
                <Accordion type="single" collapsible className="space-y-3">
                  {beforeClassItems.map((item, index) => (
                    <AccordionItem 
                      key={index} 
                      value={`item-${index}`}
                      className="border border-border/50 rounded-lg px-6 data-[state=open]:border-primary/40"
                    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
              {memberships.map((membership, index) => (
                <div
                  ...
                  className="relative bg-white p-8 rounded-xl border border-border/50 hover:border-primary/40 hover:shadow-lg transition-all duration-300 animate-fade-in"
                ...
                >
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    {membership.classes === "Unlimited" ? "Unlimited" : membership.classes} classes per month
                  </p>
                  ...
                  <p className="text-3xl font-heading italic text-foreground mb-4">
                    {membership.price}
                  </p>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
              {classPacks.map((pack, index) => (
                <div
                  key={pack.classes}
                  className="bg-white p-8 rounded-xl border border-border/50 hover:border-primary/40 hover:shadow-lg transition-all duration-300 animate-fade-in"
                  style={{ animationDelay: `${index * 0.1}s` }}
                >
                  <h3 className="text-lg font-heading italic text-foreground mb-2">
