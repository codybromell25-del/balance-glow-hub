...
const StudioEnfield = () => {
  const studioInfo = {
    ...
    heroDescription: "Whether you're a beginner or an experienced practitioner, balance. Enfield has the perfect class for you. Secure your spot with our limited Intro Offer: 3 classes for just €45, or explore our flexible class packs and memberships to suit your schedule.",
    detailDescription: "Elevate your fitness routine at the ultimate Reformer Pilates studio in Enfield. Located on Main Street in the heart of Enfield, our purpose-built studio features state-of-the-art reformers offering the ultimate boutique experience. Serving Meath and surrounding areas, we're ready to welcome you.",
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start max-w-6xl mx-auto">
              ...
              <div className="animate-fade-in" style={{ animationDelay: "0.1s" }}>
                <img src={studioEnfield} alt="balance. Enfield Studio" className="w-full h-[400px] object-cover rounded-2xl shadow-xl" />
              </div>
            </div>
          </div>
        </section>
