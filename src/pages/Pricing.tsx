  ...
  return (
    <div className="min-h-screen">
      <SEO 
        ...
        description="Flexible class packs from €24 and monthly memberships from €80. New clients: Intro Offer 3 for €50. Valid at all 6 balance studios across Limerick, Kildare, Wicklow & Meath."
        canonical="/pricing"
      />
      <Navigation />
            ...
            <div className="max-w-5xl mx-auto">
              <div className="text-center mb-8">
                <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/15 border border-primary/30 mb-4">
                  ...
                  <span className="text-foreground text-xs uppercase tracking-[0.2em] font-semibold">
                    Limerick Launch — One Week Only
                  </span>
                </div>
                <h2 className="text-3xl md:text-4xl font-heading font-bold text-foreground mb-3">
                  balance Limerick is Open
                </h2>
                <p className="text-muted-foreground text-base md:text-lg max-w-2xl mx-auto">
                  Exclusive launch offers available for one week only at our brand new Limerick studio. Once it's gone, it's gone.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6 md:gap-8">
                {[
                  ...
                  <div key={offer.title} className="relative bg-background p-8 md:p-10 rounded-2xl border-2 border-primary/40 hover:border-primary/70 hover:shadow-xl transition-all duration-300 flex flex-col animate-fade-in">
                    <div className="absolute -top-4 left-1/2 -translate-x-1/2">
                      <div className="text-black px-5 py-1.5 rounded-full text-xs uppercase tracking-[0.2em] font-semibold shadow-lg" style={{ background: 'linear-gradient(180deg, #b8d4c3 0%, #A3C1AD 40%, #8fb39c 100%)' }}>
                        Launch Offer
                      </div>
                    </div>
                    <div className="text-center mb-6 mt-2">
                      ...
                      <div className="text-5xl md:text-6xl font-heading font-bold text-foreground">
                        {offer.price}
                      </div>
                    ...
                    <Button asChild className="w-full text-lg py-6 text-black border-0 shadow-lg hover:brightness-105" style={{ background: 'linear-gradient(180deg, #b8d4c3 0%, #A3C1AD 40%, #8fb39c 100%)' }}>
              ...
              <p className="text-center text-muted-foreground mt-8 text-sm md:text-base">
                ⏳ Offer runs for one week only — from Monday to Monday. Available at balance Limerick only.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-2xl mx-auto">
              <div className="relative bg-background p-10 rounded-2xl border-2 border-primary/40 hover:border-primary/60 hover:shadow-lg transition-all duration-300 animate-fade-in">
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                  <div className="relative text-black px-6 py-2 rounded-full font-semibold flex items-center gap-2 shadow-lg overflow-hidden" style={{ background: 'linear-gradient(180deg, #b8d4c3 0%, #A3C1AD 40%, #8fb39c 100%)' }}>
