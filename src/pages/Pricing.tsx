          ...
          <div className="container mx-auto px-4">
            <div className="max-w-2xl mx-auto">
              <div className="relative bg-background p-10 rounded-2xl border-2 border-primary/40 hover:border-primary/60 hover:shadow-lg transition-all duration-300 animate-fade-in">
                ...
                <Button className="w-full text-lg py-6 relative bg-gradient-to-r from-[#9d8473] via-[#ad9383] to-[#9d8473] text-foreground border-0 shadow-lg hover:brightness-105 overflow-hidden">
