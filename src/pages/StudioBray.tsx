...
const StudioBray = () => {
  const studioInfo = {
    ...
    detailDescription:
      "Located in the IDA Business Park on Southern Cross Road, our purpose-built studio features state-of-the-art reformers offering the ultimate boutique experience. Serving Bray, Wicklow and surrounding areas, we're ready to welcome you.",
    address:
